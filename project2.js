...
// camera constants
const PROJ_LEFT = -100.0; //-40 //-100
const PROJ_RIGHT = 100.0; //40 //100
const PROJ_TOP = 110.0; //60 //110
const PROJ_BOTTOM = -110.0; //-40 //-110
const PROJ_NEAR = 100.0; //60
const PROJ_FAR = 250.0; //195
